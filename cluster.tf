...
resource "google_container_cluster" "primary" {
  ...
  network           = "projects/${local.network_project_id}/global/networks/ehrnetwork3"
  ...
  subnetwork = "projects/${local.network_project_id}/regions/${local.region}/subnetworks/ehr-vpc-network3"
